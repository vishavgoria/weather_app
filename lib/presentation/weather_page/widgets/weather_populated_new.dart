            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Text(weatherModels.formattedTemperatureNew(),
                      style: theme.textTheme
                          .apply(bodyColor: Colors.white)
                          .headline3,
                      ),
                  Text(weatherModels.formattedWindSpeed(),
                      style: theme.textTheme
                          .apply(bodyColor: Colors.white)
                          .titleSmall,
                  ),
...
extension on WeatherModels {
  String formattedTemperatureNew(){
    return '''${temperature.value.toStringAsPrecision(2)} ${temperature.unit}''';
  }
  String formattedWindSpeed(){
    return '''Wind speed: ${windspeed.value.toStringAsPrecision(2)} ${windspeed.unit}''';
  }
}
